...
ftp.login('hugof', 'azerty')

# Retrieve the welcome message, which contains the server name and version
welcome_message = ftp.getwelcome()

# Extract the server name and version from the welcome message
welcome_message = welcome_message.split('-')[1]
